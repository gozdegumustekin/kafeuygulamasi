...
import 'ıcetea.dart'; // Burada home_screen.dart'ı import ettim. (ilk sayfa)
import 'frame9.dart';
...
class Hottea extends StatefulWidget {
  ...
  @override
  _HotteaState createState() => _HotteaState();
}

class _HotteaState extends State<Hottea> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _rotatedCategory('Hot teas', true),
                    const SizedBox(height: 20),
    ...
    return GestureDetector(
      ...
      child: RotatedBox(
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isHotTea ? Colors.white : Color(0xFFE2DD8C),
            fontSize: 14,

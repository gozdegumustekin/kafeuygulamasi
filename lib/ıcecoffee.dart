...
import 'package:kafeuyg/%C4%B1cetea.dart';
import 'frame9.dart';
...
class _IcecoffeeState extends State<Icecoffee> {
  final TextEditingController _searchController = TextEditingController(); // Arama alanı kontrolü
  final List<String> _coffeeItems = [
    'Americano',
    'Cappuccino',
    'Latte',
    'Mocha',
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _rotatedCategory('Ice coffees', true),  // Ice coffees beyaz
                    const SizedBox(height: 20),
  ...
  Widget _rotatedCategory(String label, bool isIceCoffee) {
    return GestureDetector(
      ...
      child: RotatedBox(
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isIceCoffee ? Colors.white : Color(0xFFE2DD8C),
            fontSize: 14,

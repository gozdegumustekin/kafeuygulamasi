...
class _HotcoffeeState extends State<Hotcoffee> {
  TextEditingController _searchController =
      TextEditingController(); // Arama alanı kontrolü
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _rotatedCategory('Hot coffees', true), // Hot coffees beyaz
                    const SizedBox(height: 20),
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        setState(() {
                          _isSearchVisible =
                              !_isSearchVisible; // Arama kutusunu aç/kapat
                        });
                      },
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        ...
                        onPressed:
                            _closeSearchBar, // X'e basıldığında arama kutusunu kapat
                      ),
                    ),
                  ),
                ),
        ...
        onTap: (index) {
          if (index == 2) {
            ...
            Navigator.pushReplacement(
              ...
              ), // Ana sayfa olarak HomeScreen'a yönlendir
            );
          }
        },
      ),
